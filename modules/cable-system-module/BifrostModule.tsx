...
export const BifrostModule = (): React.JSX.Element => {
  ...
  return (
    <>
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              title="Bifrost"
              description="Direct, high-capacity connectivity between the Philippines, Singapore, Indonesia, and the USA — a game-changer for transpacific data demands."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Bifrost" backgroundColor="bg-white" features={BIFROST_FEATURES} />
              <ProductsSection
                title="Bifrost Plans"
                description={<></>}
      ...
      <DownloadModal isOpen={modalOpen} onClose={() => setModalOpen(false)} downloadUrl={BROCHURE_URLS.bifrost} />
    </>
  );
};
