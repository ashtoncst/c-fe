...
export const CloudDefensesModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Advanced mitigation with global cloud scrubbing centers designed to defeat the largest DDoS attacks with enterprise-grade protection."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Cloud Defenses" backgroundColor="bg-white" features={CLOUD_DEFENSES_FEATURES} />
              <ProductsSection
                title="Cloud Defense Plans"
                description={<></>}
                ...
                useMobileGrid={true}
                products={CLOUD_DEFENSES_PRODUCTS}
              />
              <TestimonialSection />
            </div>
          </main>
