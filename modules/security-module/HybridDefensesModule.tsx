...
const HYBRID_DEFENSES_FEATURES = [
...
const HYBRID_DEFENSES_PRODUCTS = [
...
export const HybridDefensesModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="An integrated solution combining on-premises and cloud-based protection for the fastest time to mitigation against the largest DDoS attacks."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Hybrid Defenses" backgroundColor="bg-white" features={HYBRID_DEFENSES_FEATURES} />
              <ProductsSection
                title="Hybrid Defense Plans"
                description={<></>}
                ...
                useMobileGrid={true}
                products={HYBRID_DEFENSES_PRODUCTS}
              />
              <TestimonialSection />
            </div>
          </main>
