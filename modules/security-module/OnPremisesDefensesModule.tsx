...
const ON_PREMISES_DEFENSES_FEATURES = [
...
const ON_PREMISES_DEFENSES_PRODUCTS = [
...
export const OnPremisesDefensesModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Quick, simple mitigation with a local scrubbing center for faster recovery and 40Gbps mitigation capacity against DDoS attacks."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why On-Premises Defenses" backgroundColor="bg-white" features={ON_PREMISES_DEFENSES_FEATURES} />
              <ProductsSection
                title="On-Premises Defense Plans"
                description={<></>}
                ...
                useMobileGrid={true}
                products={ON_PREMISES_DEFENSES_PRODUCTS}
              />
              <TestimonialSection />
            </div>
          </main>
