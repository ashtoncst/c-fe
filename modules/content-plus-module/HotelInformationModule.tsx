...
const HOTEL_INFORMATION_FEATURES = [
...
export const HotelInformationModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Display floor guides, restaurant and facility information, running bills, special promotions, and live flight and weather updates — all customizable on the TV."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Hotel Information" backgroundColor="bg-white" features={HOTEL_INFORMATION_FEATURES} />
              <ProductsSection
                title="Hotel Information Plans"
                description={<></>}
