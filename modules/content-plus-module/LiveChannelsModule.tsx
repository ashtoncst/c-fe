...
export const LiveChannelsModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Choice of Basic or Premium channel packages. Watch your favorite live TV — Kids, Sports, News, and General Entertainment."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Live Channel Packages" backgroundColor="bg-white" features={LIVE_CHANNELS_FEATURES} />
              <ProductsSection
                title="Channel Package Plans"
                description={<></>}
                ...
                useMobileGrid={true}
                products={LIVE_CHANNELS_PRODUCTS}
              />
              <TestimonialSection />
            </div>
          </main>
