...
const SECURE_CHROMCAST_FEATURES = [
...
const SECURE_CHROMCAST_PRODUCTS = [
...
export const SecureChromcastModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="No need for extra equipment. Stream your favorite movies and series directly on the hotel TV with Secure Chromecast."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Secure Chromecast" backgroundColor="bg-white" features={SECURE_CHROMCAST_FEATURES} />
              <ProductsSection
                title="Chromecast Plans"
                description={<></>}
                ...
                useMobileGrid={true}
                products={SECURE_CHROMCAST_PRODUCTS}
              />
              <TestimonialSection />
            </div>
          </main>
