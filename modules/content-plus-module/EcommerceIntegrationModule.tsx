...
const ECOMMERCE_INTEGRATION_FEATURES = [
...
const ECOMMERCE_INTEGRATION_PRODUCTS = [
...
export const EcommerceIntegrationModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Sleek digital in-room dining menu ordering seamlessly delivered to the kitchen via printer, email, or POS integrated with the hotel PMS."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why E-commerce Integration" backgroundColor="bg-white" features={ECOMMERCE_INTEGRATION_FEATURES} />
              <ProductsSection
                ...
                useMobileGrid={true}
                products={ECOMMERCE_INTEGRATION_PRODUCTS}
              />
              <TestimonialSection />
            </div>
          </main>
