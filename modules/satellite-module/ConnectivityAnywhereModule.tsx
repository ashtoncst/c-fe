...
const CONNECTIVITY_ANYWHERE_FEATURES = [
...
const CONNECTIVITY_ANYWHERE_PRODUCTS = [
...
export const ConnectivityAnywhereModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Delivers high-speed, low-latency satellite internet in remote, underserved, or hard-to-reach locations via Starlink LEO satellites."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Connectivity Anywhere" backgroundColor="bg-white" features={CONNECTIVITY_ANYWHERE_FEATURES} />
              <ProductsSection
                ...
                useMobileGrid={true}
                products={CONNECTIVITY_ANYWHERE_PRODUCTS}
              />
              <TestimonialSection />
            </div>
          </main>
