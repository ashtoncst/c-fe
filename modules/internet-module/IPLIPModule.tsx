...
export const IPLIPModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Combines the reliability of a dedicated international private line with high-performance internet protocol connectivity for global enterprises."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why IPL + IP" backgroundColor="bg-white" features={IPL_IP_FEATURES} />
              <ProductsSection
                title="IPL + IP Plans"
                description={<></>}
