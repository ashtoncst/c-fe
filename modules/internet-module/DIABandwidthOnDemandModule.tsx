...
export const DIABandwidthOnDemandModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="Access to precious bandwidth based on dynamic demands, with the capability to burst up to 2x subscribed bandwidth whenever needed."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why DIA Bandwidth-on-Demand" backgroundColor="bg-white" features={DIA_BOD_FEATURES} />
              <ProductsSection
                title="Bandwidth-on-Demand Plans"
                description={<></>}
