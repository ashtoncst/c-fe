...
export const DIAPremiumModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              title="DIA Premium"
              description="Enterprise-grade, always-on internet with multiple upstream IPs and intelligent best-route optimization for mission-critical operations."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why DIA Premium" backgroundColor="bg-white" features={DIA_PREMIUM_FEATURES} />
              <ProductsSection
                title="DIA Premium Plans"
                description={<></>}
