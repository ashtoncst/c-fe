...
export const FiberWorkFromHomeModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              ...
              description="High-speed, 100% fiber connectivity purpose-built for work-from-home professionals demanding enterprise-grade reliability."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why Business Fiber WFH" backgroundColor="bg-white" features={FIBER_WFH_FEATURES} />
              <ProductsSection
                title="WFH Fiber Plans"
                description={<></>}
