...
export const DIABasicModule = (): React.JSX.Element => {
        ...
        <div className="w-full max-w-[1920px] bg-white flex flex-col relative overflow-hidden shadow-2xl">
          ...
          <main className="flex-grow w-full relative -mt-[90px]">
            <PageHeroWithMobileCard
              title="DIA Basic"
              description="An economical dedicated internet solution for businesses needing reliable connectivity with stable performance and essential redundancy."
            ...
            <div className="relative z-10 md:-mt-20">
              <DesignedForGuestSection title="Why DIA Basic" backgroundColor="bg-white" features={DIA_BASIC_FEATURES} />
              <ProductsSection
                title="DIA Basic Plans"
                description={<></>}
