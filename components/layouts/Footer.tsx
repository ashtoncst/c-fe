...
export const Footer = (_props?: { isDisplayBanner?: boolean }) => {
  const router = useRouter();

  return (
    <footer className="bg-white pt-14 pb-3">
      <div className="max-w-[1280px] mx-auto px-4 md:px-8 lg:px-14">
        ...
        <div className="relative pb-8">
          <div className="text-center pt-4 pb-10">
            <h2
              className={`text-[35px] font-light leading-tight mb-4 text-[#024645] font-funnel`}
            >
              We&apos;re Here to Help
            </h2>
            <p
              className={`text-[16px] font-light leading-relaxed mb-8 text-black max-w-[400px] mx-auto font-dm-sans`}
            >
              Explore how pure fiber internet can power your home
              <br className="hidden md:inline" />
              {" "}or business. Our team is ready to assist you.
            </p>
            <button
              onClick={() => router.push("/contact-us")}
              className={`bg-con-custom-green text-white hover:bg-con-custom-green-bold rounded-full px-[14px] py-[8px] text-[14px] font-normal leading-[20px] md:leading-normal transition-all duration-300 font-dm-sans`}
            >
              Connect with Us
            </button>
          </div>
        ...
        <div className="flex flex-row items-center justify-between gap-6 pb-4 relative">
          ...
          <p className="font-dm-sans hidden md:block flex-1 text-center text-[14px] font-bold tracking-wider uppercase px-6 leading-snug text-[#111827]">
        ...
        {/* Divider 1 */}
        <div className="h-px bg-black/10 mb-4 -mx-4 md:mx-0" />
        ...
        <div className="grid grid-cols-[1.4fr_1fr] md:grid-cols-2 lg:grid-cols-[1.8fr_1fr_1fr_1fr_1fr] gap-x-2 gap-y-2 md:gap-8 mb-4">
          ...
          <div className="contents md:block md:space-y-0 md:order-none col-span-2 md:col-span-1">
            <div className="col-span-2 md:col-span-1 order-1 md:order-none self-start">
              <h4 className="font-bold text-[14px] leading-[30px] mb-0 font-dm-sans text-[#111827]">
                Office Address
              </h4>
            ...
            <div className="col-span-2 order-7 md:order-none md:col-span-1 self-start w-full">
              <h4 className="font-bold text-[14px] leading-[30px] mb-0 font-dm-sans text-[#111827]">
        ...
        {/* Divider 2 */}
        <div className="h-px bg-black/10 mb-3 -mx-4 md:mx-0" />
        ...
        <div className="flex flex-col items-center justify-center md:flex-row md:justify-between gap-5 text-center md:text-left pt-0 pb-1">
          <p className={`text-[13px] font-dm-sans text-black`}>
            @2026 Converge ICT Solutions. All rights reserved.
          </p>
          <div className="flex flex-row items-center justify-center gap-2 md:gap-[18px] text-[12px] md:text-[13px] font-dm-sans text-black">
            <button
              className="transition-colors hover:text-[#111827] whitespace-nowrap"
